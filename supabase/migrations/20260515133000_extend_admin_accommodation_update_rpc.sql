drop function public.update_admin_accommodation(
  uuid,
  text,
  text,
...
comment on function public.update_admin_accommodation(
  ...
  'Updates an accommodation, price rules, facilities, contacts, pool, and pet policy in one transaction. Admin-only via explicit role check and table RLS.';
